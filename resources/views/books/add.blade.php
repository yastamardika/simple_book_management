...
@section('main-content')
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ __('Add Book') }}</h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group focused">
                                    ...
                                    <input type="textarea" id="description" class="form-control" name="description" placeholder="Description" value="{{ old('description') }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label" for="email">Cover image<span class="small text-danger">*</span></label>
                                    <input type="file" id="cover" class="form-control" name="cover" placeholder="example@example.com" value="{{ old('cover') }}">
                                </div>
                            </div>
                        </div>
                    </div>
